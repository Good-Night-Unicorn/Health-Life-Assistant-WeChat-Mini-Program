...
public class JiankangmubiaoModel  implements Serializable {
	...
	public void setMubiaoleixing(String mubiaoleixing) {
		this.mubiaoleixing = mubiaoleixing;
	}
	
	/**
	 * 获取：目标类型
	 */
	public String getMubiaoleixing() {
		return mubiaoleixing;
	}
	...
	public void setShedingshijian(Date shedingshijian) {
		this.shedingshijian = shedingshijian;
	}
	
	/**
	 * 获取：设定时间
	 */
	public Date getShedingshijian() {
		return shedingshijian;
	}
