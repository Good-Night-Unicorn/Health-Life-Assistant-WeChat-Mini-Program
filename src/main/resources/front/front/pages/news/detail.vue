	...
	<view class="content">
		<view class="container" :style='{"minHeight":"100vh","width":"100%","padding":"0","position":"relative","background":"#ffecf1","height":"auto"}'>
            <view :style='{"padding":"0px","flexWrap":"wrap","background":"none","display":"flex","width":"100%","justifyContent":"space-between","height":"auto"}' class="detail-content">
				...
				<view class="detail-list-item" :style='{"padding":"0 24rpx 24rpx","margin":"0 0 0px 0","borderColor":"#ccc","borderWidth":"0 0 0px 0","background":"#fff","display":"flex","width":"100%","borderStyle":"solid","height":"auto","order":"4"}'>
				...
				<view :style='{"padding":"0 40rpx","margin":"40rpx 0 24rpx 5%","borderColor":"#ccc","textAlign":"center","display":"inline-block","minWidth":"40%","float":"left","borderRadius":"60rpx","borderWidth":"0 0 0px 0","background":"#ff9593","width":"auto","borderStyle":"solid","height":"auto","order":"5"}' class="detail-list-item" v-if="!thumbsupFlag&&!crazilyFlag" @tap="zan">
					<view :style='{"padding":"0 10rpx 0 0","color":"#333","display":"inline-block","width":"auto","lineHeight":"80rpx","fontSize":"28rpx","fontWeight":"500"}' class="lable">赞：</view>
				...
				<view :style='{"padding":"0 40rpx","margin":"40rpx 0 24rpx 5%","borderColor":"#ccc","textAlign":"center","display":"inline-block","minWidth":"40%","float":"left","borderRadius":"60rpx","borderWidth":"0 0 0px 0","background":"#ff9593","width":"auto","borderStyle":"solid","height":"auto","order":"5"}' class="detail-list-item" v-if="thumbsupFlag" @tap="zan">
					<view :style='{"padding":"0 10rpx 0 0","color":"#333","display":"inline-block","width":"auto","lineHeight":"80rpx","fontSize":"28rpx","fontWeight":"500"}' class="lable">已赞：</view>
					<view :style='{"width":"auto","flex":"1","justifyContent":"space-between","display":"inline-block","height":"auto"}'>
						<view :style='{"color":"#333","lineHeight":"80rpx","fontSize":"28rpx"}'>{{detail.thumbsupnum}}</view>
						<view :style='{"lineHeight":"80rpx","fontSize":"28rpx","color":"#333","display":"none"}' class="cuIcon-appreciate"></view>
					</view>
				</view>
				<view :style='{"padding":"0 40rpx","margin":"40rpx 5% 24rpx 0","borderColor":"#c4c4c4","textAlign":"center","display":"inline-block","minWidth":"40%","float":"right","borderRadius":"60rpx","borderWidth":"0px","background":"#ddd","width":"auto","borderStyle":"solid","height":"auto","order":"6"}' class="detail-list-item" v-if="!thumbsupFlag&&!crazilyFlag" @tap="cai">
				...
				<view :style='{"padding":"0 40rpx","margin":"40rpx 5% 24rpx 0","borderColor":"#c4c4c4","textAlign":"center","display":"inline-block","minWidth":"40%","float":"right","borderRadius":"60rpx","borderWidth":"0px","background":"#ddd","width":"auto","borderStyle":"solid","height":"auto","order":"6"}' class="detail-list-item" v-if="crazilyFlag" @tap="cai">
					<view :style='{"width":"auto","padding":"0 10rpx 0 0","lineHeight":"80rpx","fontSize":"28rpx","color":"#333","display":"inline-block"}' class="lable">踩：</view>
					<view :style='{"width":"auto","flex":"1","justifyContent":"space-between","display":"inline-block","height":"auto"}'>
						<view :style='{"color":"#333","lineHeight":"80rpx","fontSize":"28rpx"}'>{{detail.crazilynum}}</view>
						<view style="transform: rotate(180deg);" :style='{"lineHeight":"80rpx","fontSize":"28rpx","color":"#333","display":"none"}' class="cuIcon-appreciate"></view>
